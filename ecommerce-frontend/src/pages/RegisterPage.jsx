...
function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 flex items-center justify-center p-4">
      <AuthCard title="Create Account" subtitle="Join ShopZone today">
        {/* Social Login */}
        <div className="space-y-3">
          <SocialButton onClick={handleGoogleRegister} variant="google">
          ...
          <SocialButton onClick={handleFacebookRegister} variant="facebook">
